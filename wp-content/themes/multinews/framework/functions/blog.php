...
function mom_blog_post($style = 1, $nexcerpt, $class) {
	...
	if ($style == 'large') { ?>
			...
			<article <?php post_class('blog-post-big nb1 '.$class); ?> itemscope="" itemtype="http://schema.org/Article">
	...
	<?php } else { ?>
			...
			<article <?php post_class('blog-post nb1 '.$class); ?> itemscope="" itemtype="http://schema.org/Article">
				<h2 itemprop="name">
					<a itemprop="url" href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
				</h2>
				<?php if($post_head != 0) { ?>
