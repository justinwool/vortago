...
if ($lat != '' && $lon != '') {
    $today_weather_url = wp_remote_get('http://api.openweathermap.org/data/2.5/weather?lat='.$lat.'&lon='.$lon.'&units='.$units.'&lang='.$lang);    
} else {
    $today_weather_url = wp_remote_get('http://api.openweathermap.org/data/2.5/weather?q='.$city.'&units='.$units.'&lang='.$lang);
}
...
?>
                            ...
                            <div class="weather-widget">
                                ...
                                if ($lat != '' && $lon != '') {
                                $daily_weather_url = 'http://api.openweathermap.org/data/2.5/forecast/daily?lat='.$lat.'&lon='.$lon.'&mode=xml&units='.$units.'&cnt='.($days+1).'&lang='.$lang;
                                } else {
                                    $daily_weather_url = 'http://api.openweathermap.org/data/2.5/forecast/daily?q='.$city.'&mode=xml&units='.$units.'&cnt='.($days+1).'&lang='.$lang;
                                }
...
// Today Weather
if ($lat != '' && $lon != '') {
    $today_weather_url_orig = 'http://api.openweathermap.org/data/2.5/weather?mode=xml&lat='.$lat.'&lon='.$lon.'&units='.$units;
    $daily_weather_url_orig = 'http://api.openweathermap.org/data/2.5/forecast/daily?lat='.$lat.'&lon='.$lon.'&mode=xml&units='.$units.'&cnt=7';
} else {
    $today_weather_url_orig = 'http://api.openweathermap.org/data/2.5/weather?mode=xml&q='.$city.'&units='.$units;
    $daily_weather_url_orig = 'http://api.openweathermap.org/data/2.5/forecast/daily?q='.$city.'&mode=xml&units='.$units.'&cnt=7';
}
...
if ($lat != '' && $lon != '' && !isset($_POST['location'])) {
    $today_weather_url = 'http://api.openweathermap.org/data/2.5/weather?mode=xml&lat='.$lat.'&lon='.$lon.'&units='.$units.'&lang='.$lang;
} else {
    $today_weather_url = 'http://api.openweathermap.org/data/2.5/weather?mode=xml&q='.$city.'&units='.$units.'&lang='.$lang;
}
...
if ($lat != '' && $lon != '' && !isset($_POST['location'])) {
    $daily_weather_url = 'http://api.openweathermap.org/data/2.5/forecast/daily?lat='.$lat.'&lon='.$lon.'&mode=xml&units='.$units.'&cnt=7&lang='.$lang;
} else {
    $daily_weather_url = 'http://api.openweathermap.org/data/2.5/forecast/daily?q='.$city.'&mode=xml&units='.$units.'&cnt=7&lang='.$lang;    
}
...
?>
                ...
                <div class="find-weather-box">
                        <span><?php _e('Find a Forecast', 'framework'); ?></span>
                        <form action="<?php the_permalink(); ?>" method="post" id="find-weather">
                             <input type="text" name="location" id="locator-form-search"  class="<?php echo $invalid_input; ?>" value="" placeholder="<?php _e('Search for a location' , 'framework'); ?>" title="<?php _e('Search for a location' , 'framework'); ?>" maxlength="75"></span>
                       </form>
                </div>
