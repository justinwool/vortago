...
function my_theme_register_required_plugins() {
	$geo = '';
	if (get_option('geodir_installed') != 0) {
		$geo = array(
					'name'     				=> 'GeoDirectory - Multinews Theme Compatibility', // The plugin name
					'slug'     				=> 'geodirectory-multinews', // The plugin slug (typically the folder name)
					'source'   				=> get_template_directory() . '/framework/plugins/geodirectory-multinews.zip', // The plugin source
