...
<?php } else { ?>
    <?php if ( has_nav_menu( 'topnav' ) ) { 
      $top_menu_query = get_transient( 'top_menu_query'.get_queried_object_id().$lang );
...
set_transient( 'top_menu_query'.get_queried_object_id().$lang, $top_menu_query, 60*60*24 );
}
echo $top_menu_query; 
	?>  
...
<?php if(mom_option('tb_right_content') == 'custom') {
    ...
    <?php if ( has_nav_menu( 'topnav' ) ) { 
      $top_menu_query_right = get_transient( 'top_menu_query_right'.get_queried_object_id().$lang );
...
set_transient( 'top_menu_query_right'.get_queried_object_id().$lang, $top_menu_query_right, 60*60*24 );
}
