                ...
                ?>
                    ...
                    <?php else : ?>
                        <?php foreach ( $rss_items as $item ) : ?>
                            <li itemscope="" itemtype="http://schema.org/Article"><h4 itemprop="name"><span class="<?php if(is_rtl()) { ?>enotype-icon-arrow-left6<?php } else { ?>enotype-icon-arrow-right6<?php } ?>"></span><a itemprop="url" <?php echo $target; ?>href="<?php echo esc_url( $item->get_permalink() ); ?>" rel="bookmark"><?php echo esc_html( $item->get_title() ); ?></a></h4></li>
                        <?php endforeach; ?>
                    <?php endif; ?>
                <?php
                    ...
                    <li itemscope="" itemtype="http://schema.org/Article"><h4 itemprop="name"><span class="<?php if(is_rtl()) { ?>enotype-icon-arrow-left6<?php } else { ?>enotype-icon-arrow-right6<?php } ?>"></span><a itemprop="url" <?php echo $target; ?>href="<?php the_permalink(); ?>" rel="bookmark"><?php the_title(); ?></a></h4></li>
