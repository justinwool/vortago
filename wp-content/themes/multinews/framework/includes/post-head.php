...
<div class="entry-post-meta">
    ...
    ?>
    <a itemprop="author" href="<?php echo $author_link; ?>" rel="author"><?php echo get_the_author() ?></a>
    </div>
    <?php } } ?>
    <?php if(mom_option('post_head_date') != 0) { ?>
    <div><?php _e('Date: ', 'framework'); ?><time itemprop="datePublished" class="entry-date updated" datetime="<?php the_time('c'); ?>"><?php the_time($dateformat); ?></time></div>
    <?php } ?>
