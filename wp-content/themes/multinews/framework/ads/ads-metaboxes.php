...
<div class="mti_options_wrap mti_custom_size hide">
   ...
   <?php $mb->the_field('ad_layout'); ?>
	...
	<div class="mom_tiny_form_element">
   <?php $mb->the_field('ad_rand'); ?>
        <div class="mom_tiny_desc">
            <div class="mom_td_bubble">
                <label for="<?php $mb->the_name(); ?>"><?php _e('Random', 'framework'); ?></label>
                <span><?php _e('Make ads Random rotate on page refresh,', 'framework'); ?></span>
            </div> <!--bubble-->
        </div> <!--desc-->
        <div class="mom_tiny_input">
                <select name="<?php $mb->the_name(); ?>">
	                <option value="" <?php $mb->the_select_state(''); ?>><?php _e('No', 'framework'); ?></option>
	                <option value="random" <?php $mb->the_select_state('random'); ?>><?php _e('Yes', 'framework'); ?></option>
	            </select>
        </div> <!--input-->
        <div class="clear"></div>
    </div> <!--mom_meta_item-->
	...
	<div class="mom_tiny_form_element">
   <?php $mb->the_field('ad_count'); ?>
        <div class="mom_tiny_desc">
            <div class="mom_td_bubble">
                <label for="<?php $mb->the_name(); ?>"><?php _e('Number Of Ads To appear', 'framework'); ?></label>
                <span><?php _e('Use this option if you use random option', 'framework'); ?></span>
            </div> <!--bubble-->
        </div> <!--desc-->
        <div class="mom_tiny_input">
                <input type="text" id="<?php $mb->the_name(); ?>" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>" placeholder="0">
        </div> <!--input-->
        <div class="clear"></div>
    </div> <!--mom_meta_item-->
